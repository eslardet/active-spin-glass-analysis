...
//      -Metric alignemnt interactions with generalized non-reciprocal coupling constants
//      -self-propelled particles via a constant velocity vp
//      -Hybrid cell-linked list and Verlet neighbor lists
//      -Couplings are stored as the full NxN matrix in memory
//
//  Created by Thibault Bertrand on 2022-04-19
//  Last update by TB 2023-11-23
...
////////////////
    ...
    switch(couplingMode)
    {
        ...
        case 'T' : // Three populations
            ...
            inputFile >> KCA;
            inputFile >> KAC;
            logFile << " ----> Coupling Constants, KAA = " << KAA << ", KBB = " << KBB << ", KCC = " << KCC << ", KAB = " << KAB << ", KBA = " << KBA << ", KBC = " << KBC << ", KCB = " << KCB << ", KCA = " << KCA << ", KAC = " << KAC << endl; 
            break;
