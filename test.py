...
# sys.path.insert(1, '/Users/el2021/Code/2D_ActiveSpinGlass_EL/Active_Spin_Glass/analysis/analysis_functions')
...
get_sim_dir(mode="G", nPart=1000, phi=1.0, noise="0.20", K="1.0_1.0", Rp=1.0, xTy=1.0, seed=1)
