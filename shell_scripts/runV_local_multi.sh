...
if [ "${couplingMode}" == "C" ]; then
    ...
    run_dir=$HOME/Code/2D_ActiveSpinGlass_EL/simulation_data/ThreePopulations/N${nPart}/phi${phi}_n${noise}/K${KAB}_${KBC}_${KAC}/Rp${Rp}/xTy${xTy}/s${seed}
...
time ${bin_dir}/vicsek_2D_multi inpar
