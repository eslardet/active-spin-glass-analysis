...
plot_dist_coupling_hist(mode=mode, nPart=nPart, phi=phi, noise=noise, K_avg=K_avg, K_std=K_std, Rp=Rp, xTy=xTy, seed_range=seed_range, bin_size=bin_size, bin_ratio=bin_ratio, r_max=r_max, K_max=K_max, init_pos=init_pos, pos_ex=pos_ex, save_data=save_data)
