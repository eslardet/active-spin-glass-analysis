...
fig, ax = plt.subplots()
fig, ax = fun.plot_porder_Kavg_ax(mode, nPart, phi, noise_range_1, K_avg_range_1, K_std_range, xTy, seed_range, fig, ax)
fig, ax = fun.plot_porder_Kavg_ax(mode, nPart, phi, noise_range_2, K_avg_range_2, K_std_range, xTy, seed_range, fig, ax)
