...
K_avg_range = np.round(np.arange(-1.0,-0.1,0.1),1)
...
# Rp_range = np.concatenate((np.round(np.arange(0.1,1.1,0.1),1), np.arange(1.0,10.1,1.0)))
...
# plot_porder_RI(mode, nPart_range, phi_range, noise_range, K_avg_range, K_std_range, Rp_range, xTy, seed_range, save_data=False)
