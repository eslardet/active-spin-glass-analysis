...
#snapshot(mode, nPart, phi, noise, K, Rp, xTy, seed, pos_ex=True, save_in_folder=False)
...
#plot_density_profile(mode=mode, nPart=nPart, phi=phi, noise=noise, K=K, Rp=Rp, xTy=xTy, seed=seed)
